...
eval("var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {\n  if (true) {\n    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! nymph-client */ \"nymph-client\"), __webpack_require__(/*! Todo */ \"Todo\"), __webpack_require__(/*! ../actions */ \"./src/actions/index.js\")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?\n\t\t\t\t(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n  } else { var mod; }\n})(this, function (exports, _nymphClient, _Todo, _actions) {\n  'use strict';\n\n  Object.defineProperty(exports, \"__esModule\", {\n    value: true\n  });\n\n  var _Todo2 = _interopRequireDefault(_Todo);\n\n  function _interopRequireDefault(obj) {\n    return obj && obj.__esModule ? obj : {\n      default: obj\n    };\n  }\n\n  var _extends = Object.assign || function (target) {\n    for (var i = 1; i < arguments.length; i++) {\n      var source = arguments[i];\n\n      for (var key in source) {\n        if (Object.prototype.hasOwnProperty.call(source, key)) {\n          target[key] = source[key];\n        }\n      }\n    }\n\n    return target;\n  };\n\n  var currentDisconnected = false;\n\n  var todos = function todos() {\n    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { subscription: null, onPubSubConnect: null, onPubSubDisconnect: null, userCount: null, disconnected: false };\n    var action = arguments[1];\n\n    switch (action.type) {\n      case 'SUBSCRIBE':\n        {\n          if (state.subscription) {\n            state.subscription.unsubscribe();\n          }\n          if (state.onPubSubConnect) {\n            _nymphClient.PubSub.off('connect', state.onPubSubConnect);\n          }\n          if (state.onPubSubDisconnect) {\n            _nymphClient.PubSub.off('disconnect', state.onPubSubDisconnect);\n          }\n\n          var archived = action.archived;\n          var subscription = _nymphClient.Nymph.getEntities({ 'class': _Todo2.default.class }, { 'type': archived ? '&' : '!&', 'tag': 'archived' }).subscribe(function (newTodos) {\n            action.asyncDispatch((0, _actions.updateTodos)(newTodos, archived));\n          }, null, function (count) {\n            action.asyncDispatch((0, _actions.updateUserCount)(count));\n          });\n          var onPubSubConnect = function onPubSubConnect() {\n            if (currentDisconnected) {\n              action.asyncDispatch((0, _actions.subscribe)(archived));\n              action.asyncDispatch((0, _actions.refreshTodos)());\n            }\n            action.asyncDispatch((0, _actions.updateDisconnected)(false));\n          };\n\n          var onPubSubDisconnect = function onPubSubDisconnect() {\n            action.asyncDispatch((0, _actions.updateDisconnected)(true));\n          };\n\n          _nymphClient.PubSub.on('connect', onPubSubConnect);\n          _nymphClient.PubSub.on('disconnect', onPubSubDisconnect);\n\n          return _extends({}, state, { subscription: subscription, onPubSubConnect: onPubSubConnect, onPubSubDisconnect: onPubSubDisconnect });\n        }\n      case 'UPDATE_USER_COUNT':\n        return _extends({}, state, { userCount: action.userCount });\n      case 'UPDATE_DISCONNECTED':\n        currentDisconnected = action.disconnected;\n        return _extends({}, state, { disconnected: action.disconnected });\n      default:\n        return state;\n    }\n  };\n\n  exports.default = todos;\n});\n\n//# sourceURL=webpack://TodoApp/./src/reducers/subscription.js?");
